...
class WelcomeController: UIViewController,SwiftyOnboardDelegate, SwiftyOnboardDataSource {
    ...
    func swiftyOnboardOverlayForPosition(_ swiftyOnboard: SwiftyOnboard, overlay: SwiftyOnboardOverlay, for position: Double) {
        ...
        if currentPage == 0.0 || currentPage == 1.0 {
            ...
            overlay.continueButton.addTarget(self, action: #selector(done), for: .touchUpInside)
